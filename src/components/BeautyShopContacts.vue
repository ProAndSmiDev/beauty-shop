...
<template>
    <div class="bs-contacts">
        ...
        <div class="bs-contacts-phone bs-contacts__phone">
            <a
                href="tel:+14034645112"
                class="bs-contacts-phone__info"
            >
                +1&nbsp;403&nbsp;464&nbsp;5112
            </a>
            <p class="bs-contacts-phone__place">Calgary, Canada</p>
        </div>
    </div>
</template>

<style scoped lang="scss">
    @import '@/components/styles/BeautyShopContacts/component.scss';
</style>

      ...
      <div class="bs-first-screen-info__wrapper">
        <ul v-if="firstScreenType === 'full'" class="bs-first-screen-info-menu">
          <li class="bs-first-screen-info-menu__item">
            <router-link to="/makeup" class="bs-first-screen-info-menu__link">Makeup</router-link>
          </li>
          <li class="bs-first-screen-info-menu__item">
            <router-link to="/hairstyle" class="bs-first-screen-info-menu__link"
              >Hairstyle</router-link
            >
          </li>
          <li class="bs-first-screen-info-menu__item">
            <router-link to="/dresses" class="bs-first-screen-info-menu__link">Dresses</router-link>
          </li>
        </ul>
